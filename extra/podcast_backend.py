...
def get_podcast_summary(podcast_transcript):
    ...
    instructPrompt = """
    You are a comedy profesor for college level students. You listened to a podcast and would like to share a summary with your students. Please write a summary that is concise while has meaningful content for undergrad students.
...
def get_podcast_highlights(podcast_transcript):
    ...
    instructPrompt = """
    You are the podcast editor and producer. you are provided with the transcript of a podcast episode and have to identify the 5 most significant moments in the podcast as highlights
    - Each highlight needs to be a statement by one of the podcasts guest.
    - Each highlight has to be impactful and important takeaway from this episode.
    - Each highlight must be concise and make listener want to hear more about why the podcast guest said that.
    - This highlights you pick mus be spread out through the episode.

    Provide only the highlights and nothing else. Provide full sentence of the highlight and format it is as follows -
