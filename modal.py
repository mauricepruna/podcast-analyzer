...
def get_podcast_summary(podcast_transcript):
  import openai
  instructPrompt = """
    You are a college physics profesor and you are collecting information about astronomy podcasts to present to your students. You listened to a podcasta and would like to share a summary with your students. Please write a summary that is concise while has meaningful content for undergrad students. 
